...
from_label = Label(main, text = "From", width=8, height=1, pady=0, padx=0, relief="flat", anchor=NW, font=('Ivy 15 bold'),bg=cor0, fg=cor1)
from_label.place(x=48, y=90)
combol = ttk.Combobox(main, width=8, justify=CENTER, font=("Ivy 12 bold"))
combol['values'] = (currency)     
combol.place(x=50, y=115) 

to_label = Label(main, text = "To", width=8, heigh=1, pady=0, padx=0, relief="flat", anchor=NW, font=('Ivy 10 bold'),bg=cor0, fg=cor1)
...
button = Button(main,text="Converter", width=19, padx=5, pady=1, height=1, bg=cor2, fg=cor0,font=("Ivy 12 bold"), command=convert)
